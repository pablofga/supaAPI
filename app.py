...
@app.route('/')
def main_page():
    return "<html><head></head><body>@pfga A RESTful API in Flask using SQLAlchemy. For more info on usage, go to <a href>https://github.com/mgreenw/flask-restapi-example</a>.</body></html>"
